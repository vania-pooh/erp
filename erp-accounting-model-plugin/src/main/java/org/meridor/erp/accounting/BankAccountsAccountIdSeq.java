...
@Entity
@Table(name = "bank_accounts_account_id_seq", schema = "public", catalog = "erp")
public class BankAccountsAccountIdSeq {
    ...
    public boolean equals(Object o) {
        ...
        BankAccountsAccountIdSeq that = (BankAccountsAccountIdSeq) o;
