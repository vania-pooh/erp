...
@Entity
@Table(name = "product_groups_group_id_seq", schema = "public", catalog = "erp")
public class ProductGroupsGroupIdSeq {
    ...
    public boolean equals(Object o) {
        ...
        ProductGroupsGroupIdSeq that = (ProductGroupsGroupIdSeq) o;
