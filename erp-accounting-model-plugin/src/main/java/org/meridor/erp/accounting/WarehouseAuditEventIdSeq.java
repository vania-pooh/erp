...
@Entity
@Table(name = "warehouse_audit_event_id_seq", schema = "public", catalog = "erp")
public class WarehouseAuditEventIdSeq {
    ...
    public boolean equals(Object o) {
        ...
        WarehouseAuditEventIdSeq that = (WarehouseAuditEventIdSeq) o;
